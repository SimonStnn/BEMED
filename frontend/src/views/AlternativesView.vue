        ...
        <v-card class="survey-card">
          ...
          <v-card-text class="survey-content">
            ...
            <!--NEEDED: AVG(HAPI's from the selected alternatives, each question separate)-->
              ...
              <v-checkbox-group v-model="formData.questions[1]" class="survey-field" name="q1" required>
              ...
              <v-checkbox-group v-model="formData.questions[2]" class="survey-field" name="q2" required>
              ...
              <v-checkbox-group v-model="formData.questions[3]" class="survey-field" name="q3" required>
              ...
              <v-checkbox-group v-model="formData.questions[4]" class="survey-field" name="q4" required>
              ...
              <v-checkbox-group v-model="formData.questions[5]" class="survey-field" name="q5" required>
              ...
              <v-checkbox-group v-model="formData.questions[6]" class="survey-field" name="q6" required>
              ...
              <v-checkbox-group v-model="formData.questions[7]" class="survey-field" name="q7" required>
              ...
              <v-checkbox-group v-model="formData.questions[8]" class="survey-field" name="q8" required>
              ...
              <v-checkbox-group v-model="formData.questions[9]" class="survey-field" name="q9" required>
              ...
              <v-checkbox-group v-model="formData.questions[10]" class="survey-field" name="q10" required>
              ...
              <v-checkbox-group v-model="formData.questions[11]" class="survey-field" name="q11" required>
              ...
              <v-checkbox-group v-model="formData.questions[12]" class="survey-field" name="q12" required>
              ...
              <v-checkbox-group v-model="formData.questions[13]" class="survey-field" name="q13" required>
              ...
              <v-checkbox-group v-model="formData.questions[14]" class="survey-field" name="q14" required>
